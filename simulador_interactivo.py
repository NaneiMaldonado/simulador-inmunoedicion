...
def simular_paso(estado, params, seed):
    ...
    # 7. Ataque de NK
    prob_nk = 0.15 * (estado.NK / (estado.NK + 5.0))
    ...
    # 8. Ataque de CD8+
    prob_cd8 = 0.20 * (estado.CD8 / (estado.CD8 + 5.0))
    ...
    prob_m1_m2 = 0.03 + 0.07 * hormonal_phase
    ...
    prob_n1_n2 = 0.03 + 0.06 * hormonal_phase
    ...
    # 12. Agotamiento de CD8+ por Tregs
    if estado.Treg > 5.0:
        agotamiento = 0.02 * (estado.Treg / (estado.Treg + 5.0))
...
class SimuladorApp:
    def __init__(self, root):
        ...
        # Botón Reiniciar
        ttk.Button(panel, text="🔄 Reiniciar simulación", command=self.reiniciar).pack(pady=20)
